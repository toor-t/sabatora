 ...
 */
ipcMain.on(QueryDb.Request, (event: IpcMainEvent, arg: [DataDoc, (keyof DataDoc)[]]) => {
    // TODO:
 ...
 */
ipcMain.on(UpdateDb.Request, (event: IpcMainEvent, arg: [DataDoc, DataDoc]) => {
    const asyncFunc = async () => {
        try {
            // TODO:
 ...
 */
ipcMain.on(InsertDb.Request, (event: IpcMainEvent, arg: [DataDoc]) => {
    const asyncFunc = async () => {
        try {
            // TODO:
 ...
 */
ipcMain.on(RemoveDb.Request, (event: IpcMainEvent, arg: [DataDoc]) => {
    const asyncFunc = async () => {
        try {
            // TODO:
...
ipcMain.on(
    ...
    (event: IpcMainEvent, arg: [DataDoc, (keyof DataDoc)[]]) => {
        const asyncFunc = async () => {
            try {
                // TODO:
